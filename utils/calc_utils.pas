...
begin
  ...
  lMaxStep := 0.005; // коэффициент при векторе градиента (влияет на шаг смещения)
  lRestarts := 50; // внутренний параметр обучения нейросети
  lDecay := 0.001; // добавление к градиенту веса с указанным затуханием
