...
procedure MinLMSetStpMax(var State : MinLMState; StpMax : AlglibFloat);
...
function IncreaseLambda(var Lambda : AlglibFloat;
     var Nu : AlglibFloat;
     LambdaUp : AlglibFloat):Boolean;forward;
procedure DecreaseLambda(var Lambda : AlglibFloat;
     var Nu : AlglibFloat;
     LambdaDown : AlglibFloat);forward;
...
function IncreaseLambda(var Lambda : AlglibFloat;
     var Nu : AlglibFloat;
     LambdaUp : AlglibFloat):Boolean;
var
    LnLambda : AlglibFloat;
    LnNu : AlglibFloat;
    LnLambdaUp : AlglibFloat;
    LnMax : AlglibFloat;
begin
    Result := False;
    LnLambda := Ln(Lambda);
