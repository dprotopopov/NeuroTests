...
procedure TdEVDE2(const A : AlglibFloat;
     const B : AlglibFloat;
     const C : AlglibFloat;
     var RT1 : AlglibFloat;
     var RT2 : AlglibFloat);forward;
procedure TdEVDEV2(const A : AlglibFloat;
     const B : AlglibFloat;
     const C : AlglibFloat;
     var RT1 : AlglibFloat;
     var RT2 : AlglibFloat;
     var CS1 : AlglibFloat;
     var SN1 : AlglibFloat);forward;
function TdEVDPythag(A : AlglibFloat; B : AlglibFloat):AlglibFloat;forward;
function TdEVDExtSign(a : AlglibFloat; b : AlglibFloat):AlglibFloat;forward;
procedure TDINInternalDLAGTF(const N : AlglibInteger;
     var A : TReal1DArray;
     const LAMBDA : AlglibFloat;
     var B : TReal1DArray;
     var C : TReal1DArray;
     const TOL : AlglibFloat;
     var D : TReal1DArray;
...
procedure InternalDLAEBZ(const IJOB : AlglibInteger;
     ...
     const ABSTOL : AlglibFloat;
     const RELTOL : AlglibFloat;
     const PIVMIN : AlglibFloat;
     const D : TReal1DArray;
     const E : TReal1DArray;
...
procedure InternalHSEVDLALN2(const LTRANS : Boolean;
     ...
     const SMIN : AlglibFloat;
     const CA : AlglibFloat;
     const A : TReal2DArray;
     const D1 : AlglibFloat;
     const D2 : AlglibFloat;
     const B : TReal2DArray;
     const WR : AlglibFloat;
     const WI : AlglibFloat;
     ...
     var INFO : AlglibInteger);forward;
procedure InternalHSEVDLADIV(const A : AlglibFloat;
     const B : AlglibFloat;
     const C : AlglibFloat;
     const D : AlglibFloat;
     var P : AlglibFloat;
     var Q : AlglibFloat);forward;
...
Internal routine
*************************************************************************)
function TdEVDPythag(A : AlglibFloat; B : AlglibFloat):AlglibFloat;
begin
...
Internal routine
*************************************************************************)
function TdEVDExtSign(a : AlglibFloat; b : AlglibFloat):AlglibFloat;
begin
