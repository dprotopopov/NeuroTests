...
function PoissonDistribution(k : AlglibInteger; m : AlglibFloat):AlglibFloat;
function PoissonCDistribution(k : AlglibInteger; m : AlglibFloat):AlglibFloat;
function InvPoissonDistribution(k : AlglibInteger; y : AlglibFloat):AlglibFloat;
