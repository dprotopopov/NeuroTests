...
procedure Spline1DFitHermite(const X : TReal1DArray;
     ...
     var S : Spline1DInterpolant;
     var Rep : Spline1DFitReport);
function Spline1DCalc(const C : Spline1DInterpolant; X : AlglibFloat):AlglibFloat;
...
procedure Spline1DLinTransY(var C : Spline1DInterpolant;
     A : AlglibFloat;
     B : AlglibFloat);
function Spline1DIntegrate(const C : Spline1DInterpolant; X : AlglibFloat):AlglibFloat;
