...
procedure ABLASSplitLength(const A : TReal2DArray;
     ...
     var N2 : AlglibInteger);inline;
procedure ABLASComplexSplitLength(const A : TComplex2DArray;
     N : AlglibInteger;
     var N1 : AlglibInteger;
     var N2 : AlglibInteger);inline;
function ABLASBlockSize(const A : TReal2DArray):AlglibInteger;inline;
function ABLASComplexBlockSize(const A : TComplex2DArray):AlglibInteger;inline;
function ABLASMicroBlockSize():AlglibInteger;inline;
...
procedure ABLASInternalSplitLength(N : AlglibInteger;
     NB : AlglibInteger;
     var N1 : AlglibInteger;
     var N2 : AlglibInteger);forward;inline;
procedure CMatrixRightTRSM2(M : AlglibInteger;
     ...
     var X : TComplex2DArray;
     I2 : AlglibInteger;
     J2 : AlglibInteger);forward;inline;
...
procedure CMatrixSYRK2(N : AlglibInteger;
     ...
     IC : AlglibInteger;
     JC : AlglibInteger;
     IsUpper : Boolean);forward;inline;
...
procedure CMatrixGEMMK(M : AlglibInteger;
     ...
     var C : TComplex2DArray;
     IC : AlglibInteger;
     JC : AlglibInteger);forward;inline;
