...
uses Math, Sysutils, Ap, descriptivestatistics, gammafunc, normaldistr, igammaf,
  hblas, reflections, creflections, sblas, ablasf, ablas, ortfac, blas,
  rotations, bdsvd, svd;
...
procedure LRBuild(const XY: TReal2DArray; NPoints: AlglibInteger;
  NVars: AlglibInteger; var Info: AlglibInteger; var LM: LinearModel;
  var AR: LRReport);
procedure LRBuildS(const XY: TReal2DArray; const S: TReal1DArray;
  NPoints: AlglibInteger; NVars: AlglibInteger; var Info: AlglibInteger;
  var LM: LinearModel; var AR: LRReport);
procedure LRBuildZS(const XY: TReal2DArray; const S: TReal1DArray;
  NPoints: AlglibInteger; NVars: AlglibInteger; var Info: AlglibInteger;
  var LM: LinearModel; var AR: LRReport);
procedure LRBuildZ(const XY: TReal2DArray; NPoints: AlglibInteger;
  NVars: AlglibInteger; var Info: AlglibInteger; var LM: LinearModel;
  var AR: LRReport);
procedure LRUnpack(const LM: LinearModel; var V: TReal1DArray;
  var NVars: AlglibInteger);
procedure LRPack(const V: TReal1DArray; NVars: AlglibInteger;
  var LM: LinearModel);
function LRProcess(const LM: LinearModel; const X: TReal1DArray): Double;
function LRRMSError(const LM: LinearModel; const XY: TReal2DArray;
  NPoints: AlglibInteger): Double;
function LRAvgError(const LM: LinearModel; const XY: TReal2DArray;
  NPoints: AlglibInteger): Double;
function LRAvgRelError(const LM: LinearModel; const XY: TReal2DArray;
  NPoints: AlglibInteger): Double;
procedure LRCopy(const LM1: LinearModel; var LM2: LinearModel);
procedure LRSerialize(const LM: LinearModel; var RA: TReal1DArray;
  var RLen: AlglibInteger);
procedure LRUnserialize(const RA: TReal1DArray; var LM: LinearModel);
procedure LRLineS(const XY: TReal2DArray; const S: TReal1DArray;
  N: AlglibInteger; var Info: AlglibInteger; var A: Double; var B: Double;
  var VarA: Double; var VarB: Double; var CovAB: Double; var CorrAB: Double;
  var P: Double);
procedure LRLine(const XY: TReal2DArray; N: AlglibInteger;
  var Info: AlglibInteger; var A: Double; var B: Double);
...
procedure LRInternal(const XY: TReal2DArray; const S: TReal1DArray;
  NPoints: AlglibInteger; NVars: AlglibInteger; var Info: AlglibInteger;
  var LM: LinearModel; var AR: LRReport); forward;
...
begin
  ...
  begin
    ...
    //
    LM.W[Offs + NVars] := LM.W[Offs + NVars] - LM.W[Offs + J] * Means[J] /
      Sigmas[J];
    V := Means[J] / Sigmas[J];
...
begin
  ...
  while I <= NPoints - 1 do
  begin
    V := APVDotProduct(@XY[I][0], 0, NVars - 1, @LM.W[0], Offs,
      Offs + NVars - 1);
    V := V + LM.W[Offs + NVars];
...
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          while J <= K - 1 do
          begin
            R := APVDotProduct(@XY[I][0], 0, NVars - 1, @VT[J][0], 0,
              NVars - 1);
            XYM[I, J] := R;
            Inc(J);
          end;
        ...
        MatrixMatrixMultiply(AR2.C, 0, K - 1, 0, K - 1, False, VT, 0, K - 1, 0,
          NVars - 1, False, Double(1.0), VM, 0, K - 1, 0, NVars - 1,
          Double(0.0), WORK);
        MatrixMatrixMultiply(VT, 0, K - 1, 0, NVars - 1, True, VM, 0, K - 1, 0,
          NVars - 1, False, Double(1.0), AR.C, 0, NVars - 1, 0, NVars - 1,
          Double(0.0), WORK);
        Exit;
      end;
      Dec(K);
  ...
  begin
    ...
    //
    R := APVDotProduct(@XY[I][0], 0, NVars - 1, @LM.W[0], Offs,
      Offs + NVars - 1);
    AR.RMSError := AR.RMSError + AP_Sqr(R - XY[I, NVars]);
    AR.AvgError := AR.AvgError + AbsReal(R - XY[I, NVars]);
    if AP_FP_Neq(XY[I, NVars], 0) then
    begin
      AR.AvgRelError := AR.AvgRelError +
        AbsReal((R - XY[I, NVars]) / XY[I, NVars]);
      NA := NA + 1;
    end;
    ...
    if AP_FP_Neq(XY[I, NVars], 0) then
    begin
      AR.CVAvgRelError := AR.CVAvgRelError +
        AbsReal((R - XY[I, NVars]) / XY[I, NVars]);
      NACV := NACV + 1;
    end;
    NCV := NCV + 1;
